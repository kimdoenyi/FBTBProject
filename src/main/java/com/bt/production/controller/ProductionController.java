...
public class ProductionController {
	...
	public String main_page(Model model, String searchWord, HttpSession session,
		...
		List<Map<String, Object>> list = productionService.getBoardList(dept_title, dept_content, dept_writer, currPage, dept_type_no);
		List<Map<String, Object>> noticelist = productionService.getnoticeBoardList(dept_title, dept_content, dept_writer, currPage, dept_type_no);
	...
	public String board_update_page(int dept_board_no, Model model, HttpSession session) {
		...
		if (checkEmp.getEmp_code() == employeeVo.getEmp_code()) {
			...
			model.addAttribute("data", productionService.updateReadContent(dept_board_no, dept_type_no, employeeVo.getEmp_code()));
