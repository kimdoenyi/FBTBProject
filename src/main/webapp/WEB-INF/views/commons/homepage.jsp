			...
			<div class="col pl-5 pr-5" style="padding: 30px;">
				<div class="row">
                  ...
                  ${aaaa.homepageNoticeVo.hp_notice_title}
						...
						<div class="card text-center">
							<div class="card-header">
								<c:forEach var="aaaa" items="${homepage_list_Chairman }">${aaaa.homepageNoticeVo.hp_notice_title}</c:forEach>
							</div>
							<div class="card-body">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form action="./homepageNotice_modify_process.do" method="get" id="frm">
									...
									<div class="row">
										...
										<c:forEach var="aaaa" items="${homepage_list_Company }">
											<div class="col">
												<input class="form-control" type="text" id="hp_notice_title" name="hp_notice_title" value="${aaaa.homepageNoticeVo.hp_notice_title}">
											</div>
										</c:forEach>
									</div>
									...
									<div class="row">
										...
										<div class="col">
											<c:forEach var="aaaa" items="${homepage_list_Company }">
												<input class="form-control" type="text" id="hp_notice_content" name="hp_notice_content" value="${aaaa.homepageNoticeVo.hp_notice_content}">
											</c:forEach>
										</div>
									</div>
								</form>
